        ...
        protected function setConfigArray()
                {
                        ...
                        if($this->is_test == "yes")
                        {
                                ...
                                $this->configArray["apiUsername"] = "Merchant.TESTMPGS_TEST";
                 ...
                 operation: '{{operation}}'
					...
					"{{logo}}" => str_replace("http://","https://",$this->logo),
                        ...
                        $body = array(
								...
								"interaction.merchant.name"=> get_option('blogname'),
								"interaction.merchant.logo"=> str_replace("http://","https://",$this->logo),
								"interaction.locale"=> $this->language,
								//"displayControl.billingAddress"=> "HIDE",
							   // "displayControl.shipping"=> "HIDE",
							    //"displayControl.customerEmail"=> "HIDE",
                        );
